...
class RemoteStreamingRow extends StatelessWidget {
          ...
          child: Row(
            ...
            children: const [
              ...
              Column(
                ...
                children: [
                  Text('prime', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w400)),
                  Text('video', style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w400)),
                ],
              ),
            ],
          ),
  ...
  Widget _streamButton({required Widget child, required VoidCallback onTap}) {
    return Expanded(
